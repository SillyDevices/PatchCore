...
#ifndef PATCHCORE_BANDLIMITED_SAW_HPP
#define PATCHCORE_BANDLIMITED_SAW_HPP

float bandLimitedSaw(float frequency, float phase, int sampleRate);
...
#endif //PATCHCORE_BANDLIMITED_SAW_HPP
