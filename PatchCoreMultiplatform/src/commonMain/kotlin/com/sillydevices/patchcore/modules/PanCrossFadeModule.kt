...
class PanCrossFadeModule(name: String = "panCrossfade"):
    FactoryModule(name, ModuleType.PanCrossFade)
{
    val input = registerInput("in")
    val cv = registerInput("cv")
    val outputLeft = registerOutput("outL")
    val outputRight = registerOutput("outR")
