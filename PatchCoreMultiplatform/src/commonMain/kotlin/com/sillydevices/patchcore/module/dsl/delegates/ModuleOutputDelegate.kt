...
class ModuleOutputDelegate(val output: ModuleOutput): ReadOnlyProperty<PatchModule, ModuleOutput> {
    override fun getValue(thisRef: PatchModule, property: KProperty<*>): ModuleOutput {
        return output
    }
}