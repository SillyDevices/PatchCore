...
class ModuleInputDelegate(val input: ModuleInput): ReadOnlyProperty<PatchModule, ModuleInput> {
    override fun getValue(thisRef: PatchModule, property: KProperty<*>): ModuleInput {
        return input
    }
}