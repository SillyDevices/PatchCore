...
expect object PlatformModule {
    ...
    fun getModuleOutput(modulePointer: ModulePointer, outputName: String): ModuleOutputPointer
    fun getModuleInput(modulePointer: ModulePointer, inputName: String): ModuleInputPointer
    fun getUserInput(modulePointer: ModulePointer, userInputName: String): UserInputPointer
}
