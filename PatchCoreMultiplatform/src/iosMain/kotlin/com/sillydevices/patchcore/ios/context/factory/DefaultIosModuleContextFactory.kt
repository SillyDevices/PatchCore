...
internal class DefaultIosModuleContextFactory(val customModuleContextFactory: ModuleContextFactory?): ModuleContextFactory {
    ...
    private fun createKeyboardModuleContext(
        ...
        return IosKeyboardModuleContext(pointer, contextFactory)
    }
    ...
    private fun createIndicatorModuleContext(
        ...
        return IosIndicatorModuleContext(pointer, contextFactory)
    }
}