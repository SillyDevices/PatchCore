...
class NestedPatchModuleTest {
    ...
    @Test
    fun testNestedPatchModule1Step() {
        class TestSynth: ModularSynth() {

            val source by module(ConstModule("source", 0.75f))

            inner class NestedModule(name: String): PatchModule(name) {
    ...
    @Test
    fun testNestedPatchModule2Step() {
        class TestSynth: ModularSynth() {
    ...
    @Test
    fun testNestedPatchModule3Step() {
        class TestSynth: ModularSynth() {
